...
<div class="page-logo">
    <a href="<?= Url::toRoute('/') ?>">
        <?= Html::img('@web/img/logo.png', ['class' => 'logo-default', 'alt' => Yii::$app->ss->get('default-title')]) ?>
    </a>
</div>
...
<li class="dropdown dropdown-user">
    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
        <img alt="" class="img-circle hide1"
             src="http://www.gravatar.com/avatar/<?= md5(strtolower(trim(Yii::$app->user->identity->email))) ?>"/>
...
<li class="dropdown">
    <a href="<?= Url::toRoute('site/logout') ?>" data-method='post' class="dropdown-toggle">
